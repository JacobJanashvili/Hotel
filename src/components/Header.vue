    ...
    <div class="menu-items">
          ...
          :style="{
            color:
              scrollValue > 4
                ...
                : 'white',
            'pointer-events':
              router.currentRoute.value.path === '/' ? 'none' : 'auto',
          }"
          :class="{
            'menu-item': true,
          ...
          :style="{
            color:
              scrollValue > 4
                ...
                : 'white',
            'pointer-events':
              router.currentRoute.value.path === '/about' ? 'none' : 'auto',
          }"
          :class="{
            'menu-item': true,
      ...
      >
        <router-link
          ...
          :class="{
            'menu-item': true,
            active: router.currentRoute.value.path === '/attractions',
          }"
        >
          <img
            :style="[
      ...
      >
        <router-link
          ...
          :class="{
            'menu-item': true,
            active: router.currentRoute.value.path === '/kosher',
          }"
          :style="{
            'pointer-events':
              router.currentRoute.value.path === '/kosher' ? 'none' : 'auto',
            color:
              scrollValue > 4
                ? 'black'
                : router.currentRoute.value.name == 'not-found'
      ...
      >
        <router-link
          ...
          :class="{
            'menu-item': true,
            active: router.currentRoute.value.path === '/rooms',
          }"
          :style="{
            'pointer-events':
              router.currentRoute.value.path === '/rooms' ? 'none' : 'auto',
            color:
              scrollValue > 4
                ? 'black'
                : router.currentRoute.value.name == 'not-found'
      ...
      >
        <router-link
          ...
          :class="{
            'menu-item': true,
            active: router.currentRoute.value.path === '/gallery',
          }"
          :style="{
            'pointer-events':
              router.currentRoute.value.path === '/gallery' ? 'none' : 'auto',
            color:
              scrollValue > 4
                ? 'black'
                : router.currentRoute.value.name == 'not-found'
        ...
        >
          <img
            ...
            alt=""
          />
          <p class="menu-text">gallery</p>
        </router-link>
      </div>
    </div>
    <div class="booking_and_language">
      <router-link
        to="/booking"
        :style="[
          {
          ...
          { backgroundColor: btnHover ? 'black' : '' },
          {
            border: btnHover
              ? '1px solid black'
              : scrollValue > 4
      ...
      <div class="mobile-menu-last">
        <div class="language-flags">
          ...
          >
            <path
              fill="#FF473E"
              d="M1 312.52v101.445c0 7.251 4.94 13.588 11.981 15.318c159.163 39.106 318.326-43.539 477.489-8.034c9.83 2.193 19.149-5.331 19.149-15.403V312.52c-169.54-48.324-339.079 48.324-508.619 0"
            />
            <path
              fill="#0B67B2"
              d="M1 198.935v113.586c169.54 48.324 339.079-48.324 508.619 0V198.935c-169.54-48.324-339.079 48.324-508.619 0"
            />
            <path
              fill="#E8E8E8"
              d="M1 101.194v97.741c169.54 48.324 339.079-48.324 508.619 0V93.075c0-7.251-4.94-13.588-11.981-15.318c-159.163-39.106-318.326 43.539-477.489 8.034C10.319 83.599 1 91.122 1 101.194"
            />
          </svg>
          <svg
            class="american-flag"
          ...
          >
            ...
            <path
              fill="#e6e7e8"
              d="M61.6 14.38H26v3.38h37.39c-.406-1.261-1.01-2.411-1.79-3.38"
            />
            <path
              fill="#ec1c24"
              d="M54 11H26v3.38h35.6C59.931 12.29 57.184 11 54 11"
            />
            <path
              fill="#e6e7e8"
              d="M63.965 21.14H26v3.38h38v-2.253c0-.201-.013-.397-.019-.594c-.004-.054-.01-.193-.016-.533"
            />
            <path fill="#ec1c24" d="M26 27.9h38v-3.38H26z" />
            <path fill="#e6e7e8" d="M26 31.28h38V27.9H26z" />
          ...
          >
            ...
            <path
              fill="#EEE"
              d="M0 25h36V11H0zM.294 7.5h35.413A4 4 0 0 0 32 5H4A3.999 3.999 0 0 0 .294 7.5"
            />
            <path
              fill="#EDECEC"
...
const selectedLanguage = ref("ENG"); // Initial language selection
const languages = ["ENG", "РУС", "יבר"];
