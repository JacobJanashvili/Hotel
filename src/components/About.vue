...
const roomsToDisplay = computed(() => {
  return roomsList.value.filter((room) => room.shortDescription);
});
...
onMounted(() => {
  roomsList.value = store.getters.getRoomsList;
});
</script>
<template>
  <Header />
  <main>
    ...
    <div class="about-us-text">
      <p>
        Boutique hotel located in the Old City of Tbilisi, within 5-minutes
        walking distance to the Freedom Square and all major tourist-haunted
        sites, attractions and places of entertainment.
      </p>
      <p>
        The 12-room hotel design was developed by the representatives of
        well-known Kavlashvili Architects’ Dynasty, whereas the interior &
        decorative design is the work of internationally acclaimed artist Koba
        Pirstkhalaishvili. The authors managed to merge the aura and features of
        Old Tbilisi with modern and futuristic concepts. The hotel compound
        consists of 3 individual 3-story buildings interconnected with open
        bridges and inner courtyard. All buildings share common underground
        dining area
      </p>
      <p>
        All clients can appreciate Kosher, healthy and homemade breakfast and
        free Wi-Fi internet throughout the entire property. Hotel offers high
        level of service and comfortable accommodation.
      </p>
      <p>
        For those who observe Shabbat and Kashrut, the hotel is also situated
        within 5-minutes walking distance to both Great and Ashkenazi
        Synagogues, Chabad Georgia Center and kosher restaurants.
      </p>
    </div>
    <div class="about-us-rooms-wrapper">
      <h2 class="about-us-rooms-title">Our Rooms</h2>
      <div class="about-us-room" v-for="room in roomsToDisplay">
        ...
        <div
          class="about-us-rooms-link"
          @click="onRoomClick(room), (isRoomOpen = true)"
        >
          <p>View</p>
